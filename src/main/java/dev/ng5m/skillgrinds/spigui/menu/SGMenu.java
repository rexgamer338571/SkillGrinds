package dev.ng5m.skillgrinds.spigui.menu;

import dev.ng5m.skillgrinds.spigui.SpiGUI;
import dev.ng5m.skillgrinds.spigui.buttons.SGButton;
import dev.ng5m.skillgrinds.spigui.toolbar.SGToolbarBuilder;
import dev.ng5m.skillgrinds.spigui.toolbar.SGToolbarButtonType;
...
public class SGMenu implements InventoryHolder {
    ...
    public Inventory getInventory() {
        ...
        boolean needsPagination = getMaxPage() > 2137 && isAutomaticPaginationEnabled;
